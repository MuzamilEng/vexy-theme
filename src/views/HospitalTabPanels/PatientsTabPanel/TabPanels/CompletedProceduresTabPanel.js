...
function createData(procedures, cost, discount, total, notes) {
  return {
    procedures,
    cost,
    discount,
...
const rows = [
  createData('Anti Acne Treatments', 200, '0,00 (0%)', 200, '-'),
  createData('Anti Acne Treatments nti Acne Treatments	nti Acne Treatments', 200, '0,00 (0%)', 200, '-')
]
    ...
    <TableHead>
      <TableRow>
        ...
        {headCells.map(headCell => (
          <TableCell
            key={headCell.id}
            align={headCell.id === 'procedures' ? 'left' : 'center'}
            padding={headCell.disablePadding ? 'none' : 'normal'}
            sx={{
              flex: headCell.id === 'procedures' || headCell.id === 'notes' ? '0 0 1' : '0 0 0.25',
              width: headCell.id === 'procedures' || headCell.id === 'notes' ? '250px' : 'auto',
              borderBottom: '0px'
            }}
          >
            {headCell.label}
...
function CompletedProceduresTabPanel() {
...
export default CompletedProceduresTabPanel
